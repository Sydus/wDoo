...
from wdoo.sql_db import TestCursor
from wdoo.tools import (config, existing_tables, ignore,
                        lazy_classproperty, lazy_property, sql,
                        Collector, OrderedSet)
from wdoo.tools.lru import LRU

_logger = logging.getLogger(__name__)
_schema = logging.getLogger('wdoo.schema')
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # wdoo.service.wsgi_server.application
    ...
    def new(cls, db_name, force_demo=False, status=None, update_module=False):
        ...
        with cls._lock:
            ...
            try:
                ...
                try:
                    wdoo.modules.load_modules(registry, force_demo, status, update_module)
                except Exception:
                    wdoo.modules.reset_modules_state(db_name)
                    raise
            except Exception:
    ...
    def init(self, db_name):
        ...
        self._db = wdoo.sql_db.db_connect(db_name)
        ...
        with closing(self.cursor()) as cr:
            self.has_unaccent = wdoo.modules.db.has_unaccent(cr)
            self.has_trigram = wdoo.modules.db.has_trigram(cr)
