...
from wdoo.modules.module import get_module_root, MANIFEST_NAMES
from wdoo.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the wdoo server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            wdoo.tools.config['init']['base'] = True
