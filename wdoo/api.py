...
"""The wdoo API module defines wdoo Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~wdoo.exceptions.ValidationError` if the
    validation failed.
    .. warning::
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~wdoo.addons.base.models.res_users`
            :type su: bool
        """
...
from wdoo.exceptions import UserError, AccessError, MissingError
