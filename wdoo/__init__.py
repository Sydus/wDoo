...
#----------------------------------------------------------
# wdoo must be a namespace package for wdoo.addons to become one too
...
if len(sys.argv) > 1 and sys.argv[1] == 'gevent':
    ...
    def gevent_wait_callback(conn, timeout=None):
        ...
        # under the BSD license (see in wdoo/debian/copyright)
        while 1:
            state = conn.poll()
...
from . import fields
from . import api
from wdoo.tools.translate import _, _lt
from wdoo.fields import Command
