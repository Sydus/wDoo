...
function documentationItem(env) {
    const documentationURL = "https://www.wdoo.com/documentation/15.0";
    return {
        type: "item",
        id: "documentation",
    ...
    return {
        ...
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.location.href = "https://accounts.wdoo.com/account";
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("wdoo_account", wdooAccountItem)
