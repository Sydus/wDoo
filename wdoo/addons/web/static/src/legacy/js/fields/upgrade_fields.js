wdoo.define('web.upgrade_widgets', function (require) {
"use strict";
...
var AbstractFieldUpgrade = {
    ...
    /**
     * Redirects the user to the wdoo-enterprise/uprade page
     *
     * @private
     * @returns {Promise}
     */
    _confirmUpgrade: function () {
        return this._rpc({
            ...
            .then(function (data) {
                framework.redirect("https://www.wdoo.com/wdoo-enterprise/upgrade?num_users=" + data);
            });
    },
    /**
