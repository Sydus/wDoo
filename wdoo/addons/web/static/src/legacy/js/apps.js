wdoo.define('web.Apps', function (require) {
"use strict";
    ...
    start: function() {
        ...
        return new Promise(function (resolve, reject) {
            self.get_client().then(function (client) {
                ...
                self.displayNotification({ title: _t('Wdoo Apps will be available soon'), message: _t('Showing locally available modules'), sticky: true, type: 'danger' });
                return self._rpc({
