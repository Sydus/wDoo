/** @wdoo-module alias=web.ListController **/
...
var ListController = BasicController.extend({
    ...
    /**
     * Save the row in edition, if any, when we are about to leave Wdoo.
     *
     * @override
     */
    ...
    _onDiscardMousedown: function (ev) {
        ...
        window.addEventListener('mouseup', function (mouseupEvent) {
            ...
            if (ev.target !== mouseupEvent.target && preventedEvent.constructor.name === 'WdooEvent') {
