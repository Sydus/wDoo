/** @wdoo-module alias=web.AbstractView **/

/**
 * This is the base class inherited by all (JS) views. Wdoo JS views are the
 ...
 * the word 'view' has historical significance in Wdoo code, so we replaced the
