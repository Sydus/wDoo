wdoo.define('web.Session', function (require) {
"use strict";
...
var Session = core.Class.extend(mixins.EventDispatcherMixin, {
    ...
    load_qweb: function () {
        return this.qweb_mutex.exec(async () => {
            let templates;
            if (wdoo.loadTemplatesPromise) {
                templates = await wdoo.loadTemplatesPromise;
            } else {
    ...
    rpc: function (url, params, options) {
        ...
        // we add here the user context for ALL queries
