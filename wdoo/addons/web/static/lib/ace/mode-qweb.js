    ...
    var QWebHighlightRules = function () {
        ...
        this.$rules = Object.assign({},
            xmlRules,
            {
                ...
                attributes_wdoo: [{
                    token: ["entity.other.attribute-name.xml.wdoo", "keyword.operator.attribute-equals.xml", "text", "string.attribute-value.xml.start", "string.attribute-value.xml.code", "string.attribute-value.xml.end"],
