...
define("ace/lib/regexp", ["require", "exports", "module"], function(e, t, n) {
    ...
    (function() {
        ...
        // WDOO monkeypatch: When we use firefox top or bottom arrow the ace container does not scroll automatically if the cursor is not visible.
