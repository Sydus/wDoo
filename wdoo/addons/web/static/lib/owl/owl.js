...
See https://github.com/wdoo/owl/blob/master/doc/reference/config.md#mode for more information.`);
            }
        },
    });
    ...
    class Component {
         ...
         *  - it can be patched (useful in wdoo ecosystem)
  ...
  `;
    ...
    __info__.url = 'https://github.com/wdoo/owl';
