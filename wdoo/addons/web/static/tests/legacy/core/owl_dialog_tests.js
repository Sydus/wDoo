...
wdoo.define('web.owl_dialog_tests', function (require) {
    ...
    QUnit.module('core', {}, function () {
        ...
        QUnit.test("Rendering of all props", async function (assert) {
            ...
            assert.containsNone(document.body, '.modal-backdrop'); // No backdrop *element* for Wdoo modal...
            ...
            // Title (default: 'Wdoo')
            assert.strictEqual(dialog.querySelector('h4.modal-title').innerText.trim(), "Wdoo" + "The Subtitle",
