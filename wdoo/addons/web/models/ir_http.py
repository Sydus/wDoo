...
import wdoo
from wdoo import api, http, models
from wdoo.http import request
from wdoo.tools import file_open, image_process, ustr
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = wdoo.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.wdoo.com/buy",
            "name": user.name,
            "username": user.login,
            "partner_display_name": user.name,
    ...
    def _content_image_get_response(self, status, headers, image_base64, model='ir.attachment',
        ...
        if not image_base64:
            ...
            if not (width or height):
                width, height = wdoo.tools.image_guess_size_from_field_name(field)
        try:
