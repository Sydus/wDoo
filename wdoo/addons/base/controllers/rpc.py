...
from wdoo.http import Controller, dispatch_rpc, request, route
from wdoo.service import wsgi_server
from wdoo.fields import Date, Datetime, Command
from wdoo.tools import lazy, ustr
from wdoo.tools.misc import frozendict


# ustr decodes as utf-8 or latin1 so we can search for the ASCII bytes
# 	Char	   ::=   	#x9 | #xA | #xD | [#x20-#xD7FF]
XML_INVALID = re.compile(b'[\x00-\x08\x0B\x0C\x0F-\x1F]')
class wdooMarshaller(xmlrpc.client.Marshaller):
    ...
    # Historically, wdoo is sending binary as base64 string.
...
xmlrpc.client.Marshaller = wdooMarshaller
