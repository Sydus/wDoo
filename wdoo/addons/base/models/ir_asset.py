...
from wdoo import tools
from wdoo.addons import __path__ as ADDONS_PATH
from wdoo import api, fields, http, models
...
class IrAsset(models.Model):
    ...
    def _get_installed_addons_list(self):
        ...
        return self.env.registry._init_modules | set(wdoo.conf.server_wide_modules or []) | set(self.env.context.get('install_module', []))
