...
from wdoo import api, Command, fields, models, _
from wdoo.tools import ustr
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an wdoo
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`wdoo.osv.orm.Model.write` expects.

        :param model: :class:`wdoo.osv.orm.Model` for the conversion base
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`wdoo.fields.Field`
        :param fromtype: type to convert to something fitting for ``field``
        :type fromtype: type | str
        :param context: wdoo request context
