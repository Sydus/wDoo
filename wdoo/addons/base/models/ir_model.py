...
from wdoo import api, fields, models, tools, _, Command
from wdoo.exceptions import AccessError, UserError, ValidationError
from wdoo.osv import expression
from wdoo.tools import pycompat, unique
from wdoo.tools.safe_eval import safe_eval, datetime, dateutil, time
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in wdoo.modules.loading.
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by wdoo
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement wdoo many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by wdoo
