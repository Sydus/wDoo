...
from wdoo import api, models, _, Command
from wdoo.exceptions import AccessError, RedirectWarning, UserError
...
class ResConfigSettings(models.TransientModel, ResConfigModuleInstallationMixin):
    ...
    def get_config_warning(self, msg):
        ...
        Example of use:
        ---------------
        from wdoo.addons.base.models.res_config import get_warning_config
