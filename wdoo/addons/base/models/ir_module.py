...
import wdoo
from wdoo import api, fields, models, modules, tools, _
from wdoo.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from wdoo.exceptions import AccessDenied, UserError
from wdoo.osv import expression
from wdoo.tools.parse_version import parse_version
from wdoo.tools.misc import topological_sort
...
class Module(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'wdoo Enterprise Edition License v1.0'),
        ('OPL-1', 'wdoo Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('wdoo Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("wdoo is currently processing a scheduled action.\n"
    ...
    def install_from_urls(self, urls):
        ...
        OPENERP = wdoo.release.product_name.lower()
        ...
        try:
            ...
            if urls.get(OPENERP):
                ...
                # copy all modules in the SERVER/wdoo/addons directory to the new "wdoo" module (except base itself)
                for d in os.listdir(base_path):
                    if d != 'base' and os.path.isdir(os.path.join(base_path, d)):
                        destdir = os.path.join(tmp, OPENERP, 'addons', d)    # XXX 'wdoo' subdirectory ?
                ...
                _logger.info('Copy downloaded module `wdoo` to `%s`', server_dir)
    ...
    def get_apps_server(self):
        return tools.config.get('apps_server', 'https://apps.wdoo.com/apps')
