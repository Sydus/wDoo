...
from wdoo import api, fields, models, tools, SUPERUSER_ID, _
from wdoo.exceptions import AccessError, ValidationError
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - wdoo/addons/test_access_rights/tests/test_feedback.py
        # - wdoo/addons/test_access_rights/tests/test_ir_rules.py
        # - wdoo/addons/base/tests/test_orm.py (/home/dle/src/wdoo/master-nochange-fp/wdoo/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
