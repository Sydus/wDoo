...
from wdoo import api, fields, models, Command
from wdoo import SUPERUSER_ID, _
from wdoo.exceptions import ValidationError, UserError
from wdoo.tools import mute_logger

_logger = logging.getLogger('wdoo.addons.base.partner.merge')
    ...
    def _update_foreign_keys(self, src_partners, dst_partner):
        ...
        for table, column in relations:
            ...
            if len(columns) <= 1:
                ...
                try:
                    with mute_logger('wdoo.sql_db'), self._cr.savepoint():
