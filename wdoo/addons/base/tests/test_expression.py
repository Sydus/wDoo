...
from wdoo.addons.base.tests.common import SavepointCaseWithUserDemo
from wdoo.fields import Date
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('wdoo.osv.expression'):
    ...
    @mute_logger('wdoo.models.unlink')
