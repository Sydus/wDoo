...
from wdoo.tests.common import BaseCase
from wdoo.tools.misc import mute_logger

ADMIN_USER_ID = common.ADMIN_USER_ID

def registry():
    return wdoo.registry(common.get_db_name())
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = wdoo.api.Environment(self.cr, wdoo.SUPERUSER_ID, {})
