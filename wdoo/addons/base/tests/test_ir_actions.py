...
import wdoo
from wdoo.exceptions import UserError, ValidationError, AccessError
from wdoo.tools import mute_logger
from wdoo.tests import common
from wdoo import Command
...
class TestServerActions(TestServerActionsBase):
    ...
    @mute_logger('wdoo.addons.base.models.ir_model', 'wdoo.models')
    ...
    def test_80_permission(self):
        ...
        with self.assertRaises(AccessError), mute_logger('wdoo.addons.base.models.ir_actions'):
            self_demo.with_context(self.context).run()
...
class TestCustomFields(common.TransactionCase):
    ...
    def test_create_unique(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('wdoo.sql_db'):
            self.create_field('x_foo')
