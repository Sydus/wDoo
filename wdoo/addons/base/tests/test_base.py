...
from wdoo import SUPERUSER_ID, Command
from wdoo.exceptions import RedirectWarning, UserError, ValidationError
from wdoo.tests.common import TransactionCase, BaseCase
from wdoo.tools import mute_logger
from wdoo.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('wdoo.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import wdoo", mode="exec")
