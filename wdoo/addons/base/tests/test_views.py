...
from wdoo.tests import common
from wdoo.tools import mute_logger, view_validation
from wdoo.addons.base.models.ir_ui_view import (
...
class TestApplyInheritanceSpecs(ViewCase):
    ...
    @mute_logger('wdoo.addons.base.models.ir_ui_view')
...
class TestViews(ViewCase):
    ...
    def test_partial_validation(self):
        ...
        with mute_logger('wdoo.addons.base.models.ir_ui_view'):
            with self.assertRaises(ValidationError):
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view'):
        with self.assertLogs('wdoo.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
