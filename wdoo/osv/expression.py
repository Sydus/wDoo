...
term representation was ['=', 'company_id.name', 'wdoo']. Used in a
...
wdoo will use the SQL function 'unaccent' when available for the
...
Finally, to instruct wdoo to really use the unaccent function, you have to
...
import wdoo.modules
from wdoo.osv.query import Query, _generate_table_alias
...
def get_unaccent_wrapper(cr):
    if wdoo.registry(cr.dbname).has_unaccent:
